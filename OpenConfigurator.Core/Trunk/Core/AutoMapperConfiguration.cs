...
namespace OpenConfigurator.Core
{
    public static class AutoMapperConfiguration
    {
        public static void Configure()
        {
            ...
            Mapper.CreateMap<OpenConfigurator.Core.BLOs.FeatureModel, OpenConfigurator.Core.XmlDAL.DataEntities.FeatureModel>().ReverseMap();
            Mapper.CreateMap<OpenConfigurator.Core.BLOs.Feature, OpenConfigurator.Core.XmlDAL.DataEntities.Feature>().ReverseMap();
            Mapper.CreateMap<OpenConfigurator.Core.BLOs.Attribute, OpenConfigurator.Core.XmlDAL.DataEntities.Attribute>().ReverseMap();
            Mapper.CreateMap<OpenConfigurator.Core.BLOs.CustomRule, OpenConfigurator.Core.XmlDAL.DataEntities.CustomRule>().ReverseMap();
            Mapper.CreateMap<OpenConfigurator.Core.BLOs.CustomFunction, OpenConfigurator.Core.XmlDAL.DataEntities.CustomFunction>().ReverseMap();
            Mapper.CreateMap<OpenConfigurator.Core.BLOs.ModelFile, OpenConfigurator.Core.XmlDAL.DataEntities.ModelFile>().ReverseMap();

            // Mappings with Identifier references (BLO to DataEntity)
            Mapper.CreateMap<OpenConfigurator.Core.BLOs.Relation, OpenConfigurator.Core.XmlDAL.DataEntities.Relation>();
            Mapper.CreateMap<OpenConfigurator.Core.BLOs.GroupRelation, OpenConfigurator.Core.XmlDAL.DataEntities.GroupRelation>()
                .ForMember(dest => dest.ChildFeatureIdentifiers, opt => opt.MapFrom(so => so.ChildFeatures.Select(f => f.Identifier).ToList()));
            Mapper.CreateMap<OpenConfigurator.Core.BLOs.CompositionRule, OpenConfigurator.Core.XmlDAL.DataEntities.CompositionRule>();

            // Mappings with Identifier references (DataEntity to BLO)
            Mapper.CreateMap<OpenConfigurator.Core.XmlDAL.DataEntities.Relation, OpenConfigurator.Core.BLOs.Relation>()
            ...
            Mapper.CreateMap<OpenConfigurator.Core.XmlDAL.DataEntities.GroupRelation, OpenConfigurator.Core.BLOs.GroupRelation>()
                .ForMember(dest => dest.ParentFeature, opt => opt.ResolveUsing<FeatureReferenceIDConverter>().FromMember(src => src.ParentFeatureIdentifier))
            ...
            Mapper.CreateMap<OpenConfigurator.Core.XmlDAL.DataEntities.CompositionRule, OpenConfigurator.Core.BLOs.CompositionRule>()
