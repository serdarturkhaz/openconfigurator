...
UIControls.VisualView = function (container, dataModel) {
    ...
    var _scaleModifier = 1, _fixedOrientation = "vertical";
    var _currentModelCLO = null;
    var _visualUIElems = {};
...
UIControls.VisualView.FeatureElem = function (featureCLO, parentCanvasInstance) {
    ...
    var _boxDimensions = {
        width: UIObjectStyles.feature.general.box.dimensions.width,
        height: UIObjectStyles.feature.general.box.dimensions.height
    }
    var _this = this;
    ...
    this.Initialize = function () {
        ...
        _innerElements.box.attr(UIObjectStyles.feature.states[_currentState].box.attr);
        _innerElements.text = _canvasInstance.text(_boxDimensions.width / 2 + featureCLO.XPos(), _boxDimensions.height / 2 + featureCLO.YPos(), _featureCLO.Name()).attr(UIObjectStyles.feature.states[_currentState].text.attr);
        _innerElements.text.attr({ "font-size": parseFloat(UIObjectStyles.feature.general.text["font-size"]) });
        _outerElement = _canvasInstance.rect(featureCLO.XPos(), featureCLO.YPos(), _boxDimensions.width, _boxDimensions.height).attr(systemDefaults.common.outerElement.attr);
